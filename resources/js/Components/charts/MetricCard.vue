    ...
    <Card class="flex flex-col">
        <div class="flex items-start justify-between gap-3 px-5 pt-5">
            <div class="flex items-center gap-2 min-w-0">
                ...
                >
                    <span class="h-4 w-4" style="color: hsl(240 5.9% 10%);" v-html="icon" />
                </span>
            ...
            <button
                type="button"
                class="shrink-0 rounded-full p-1 transition-colors hover:bg-[hsl(240_4.8%_95.9%)]"
                aria-label="More information"
            >
                <svg class="h-4 w-4" style="color: hsl(240 3.8% 46.1%);" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="flex items-end justify-between gap-3 px-5 pt-4">
            <div>
                <p class="text-2xl font-bold tracking-tight" style="color: hsl(240 10% 3.9%);">
                    {{ value }}
                </p>
        ...
        <div
            class="mt-5 flex items-center justify-between border-t px-5 py-3 text-xs"
