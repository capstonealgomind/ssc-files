...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    this.scale = this.screen.height / (this.screen.width < 640 ? 1100 : this.screen.width < 1024 ? 1300 : 1500);
    const cardWidth = this.screen.width < 640 ? 480 : this.screen.width < 1024 ? 580 : 700;
    const cardHeight = this.screen.width < 640 ? 640 : this.screen.width < 1024 ? 760 : 900;
    ...
    this.padding = this.screen.width < 640 ? 1.15 : this.screen.width < 1024 ? 1.5 : 2;
...
class App {
  ...
  onTouchMove(e: MouseEvent | TouchEvent) {
    ...
    const touchBoost = this.screen?.width && this.screen.width < 1024 ? 0.055 : 0.025;
    const distance = (this.start - x) * (this.scrollSpeed * touchBoost);
