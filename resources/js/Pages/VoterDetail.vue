                    ...
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="flex flex-wrap gap-1.5 mt-1.5">
                                ...
                                <span v-if="voter.is_disabled" class="text-xs font-semibold px-1.5 py-0.5 rounded uppercase tracking-wide"
                                    style="background:hsl(0 84% 94%); color:hsl(0 72% 35%);">
                                    Disabled
                                </span>
                                <span v-else-if="voter.is_expired" class="text-xs font-semibold px-1.5 py-0.5 rounded uppercase tracking-wide"
                                    style="background:hsl(0 84% 94%); color:hsl(0 72% 35%);">
                                    Expired
                                </span>
                                <span v-else-if="voter.is_verified" class="inline-flex items-center gap-1 text-xs px-1.5 py-0.5 rounded"
